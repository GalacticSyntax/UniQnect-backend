...
const createCurriculumEquivalentCourseValidationSchema = zod.object({
  text: zod.string({
...
export const CurriculumEquivalentCourseValidation = {
  createCurriculumEquivalentCourseValidationSchema,
};
